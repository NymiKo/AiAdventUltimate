...
class RAGService(
    ...
    fun buildRAGPrompt(userQuestion: String, context: String): String {
        ...
        return """
ВАЖНО: Используй ТОЛЬКО следующую информацию из базы знаний для ответа на вопрос пользователя.
НЕ придумывай и НЕ добавляй информацию, которой нет в предоставленном контексте.
Если предоставленной информации недостаточно для полного ответа, четко укажи это, а не выдумывай детали.
